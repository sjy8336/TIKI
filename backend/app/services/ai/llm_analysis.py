    ...
    def _build_instructions(context: Any | None = None, *, source_kind: str | None = None) -> str:
        ...
        if normalized_source_kind == "document":
            instruction += (
                ...
                "- 담당자는 participants/admins 목록 안의 이름만 사용하라. 문서의 표, 행, 문장, 괄호, 이름+업무 패턴에 참여자 이름이 보이면 해당 참여자로 적극 매칭하라.\n"
                "- 담당자 단서가 전혀 없을 때만 null로 두고, 마감일은 명시되지 않으면 null로 둬라.\n"
            ...
            instruction += (
                ...
                "- 담당자는 participants/admins 목록 안의 이름만 사용하라. 발화자, 지시 대상, 이름+업무 패턴에 참여자 이름이 보이면 해당 참여자로 적극 매칭하라.\n"
                "- 담당자 단서가 전혀 없을 때만 null로 두고, 마감일은 명시되지 않으면 null로 둬라.\n"
